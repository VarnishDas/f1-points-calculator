      ...
      <div className="border-b border-white/10 p-2">
        <div className="grid grid-cols-2 rounded-md border border-white/10 bg-black/25 p-1">
          <button
            ...
            className={
              mode === "drivers"
                ? "h-9 rounded bg-amber-500/10 px-2 text-xs font-black text-amber-400 ring-1 ring-amber-500/50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400 sm:h-8 sm:text-[11px]"
                : "h-9 rounded px-2 text-xs font-bold text-neutral-500 transition hover:text-neutral-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400 sm:h-8 sm:text-[11px]"
            }
          >
            Drivers
          </button>
          ...
          <table className="w-full border-collapse text-xs">
            ...
            <thead className="sticky top-0 z-10 bg-neutral-950">
              <tr className="border-b border-white/10 text-left text-[11px] uppercase tracking-wide text-neutral-500">
                <th scope="col" className="sticky left-0 z-20 w-10 bg-neutral-950 px-2 py-2 font-bold sm:px-4">
                ...
                <th scope="col" className="w-16 px-2 py-2 text-right font-bold sm:px-4">
