    ...
    <footer className="shrink-0 border-t border-white/10 bg-neutral-950/75 px-3 py-3 text-center text-[11px] leading-relaxed text-neutral-500 lg:px-4 lg:py-2">
      <p>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="rounded-sm text-neutral-400 underline decoration-neutral-700 underline-offset-2 transition hover:text-amber-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400"
        >
          Varnish Das
        </a>
        . Data powered by{" "}
