    ...
    <div className="grid flex-1 gap-3 p-3 lg:min-h-0 lg:grid-cols-[280px_minmax(0,1fr)] lg:overflow-hidden">
      <div className="min-w-0 lg:flex lg:min-h-0 lg:flex-col lg:overflow-hidden">
        <button
          ...
          className="mb-3 flex h-11 w-full items-center justify-between rounded-md border border-white/10 bg-neutral-950/75 px-3 text-xs font-black uppercase tracking-[0.12em] text-neutral-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400 lg:hidden"
